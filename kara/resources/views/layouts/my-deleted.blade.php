@if(count($posts) == 0)
    <div class="col-12 alert alert-info mt-3 text-center w-100 mr-auto ml-auto float-right">شما هنوز هیچ آگهی حذف شده ای بر روی کارا ندارید</div>
@else
        ...
        <div class="col-9 col-lg-10 float-right ">
            ...
            <div class="row my-2">
                <div class="col-lg-6 float-right my-2">
                    <div class="float-right IranBold13 fw-400 text-info text-right">@if($post->is_expired) {{ getTimeAgo($post->deleted_at)."  منقضی شده" }} @else{{getTimeAgo($post->deleted_at). " حذف شده" }} @endif</div>
