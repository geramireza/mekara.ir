...
@section("content")
    <div class="container">
        <div class="row">
            <div class="col-md-10 my-3 my-5 ml-auto mr-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route("admin.store")}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <span id="check1" class="me-span-checkbox ml-2 @if(old("emergency") == "on") me-checked @endif" >
                                    <input name="emergency" type="checkbox" class="form-control me-input-checkbox ml-1 opacity-none" @if(old("emergency") == "on") checked @endif>
                                </span>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <small class="float-right">انتخاب تصویر مناسب سبب دیده شدن بیشتر آگهی شما می شود</small>
                                        </div>
                                        <div class="row d-flex justify-content-center">
                                            <div id="img1" class="col-4 col-md-3 my-5">
                                            ...
                                            <div id="img2" class="col-4 col-md-3 my-5">
                                                <div class="picture text-center">
                                            ...
                                            <div id="img3" class="col-4 col-md-3 my-5">
